...
When running as a guided conversation, use these interaction conventions:
- session heads-up + entry mode (Guided, Context dump, Best guess)
- one-question turns with plain-language prompts
- progress labels (for example, Phase Qx/6 and Activity x/y)
...
- **Technique:** Structured problem framing, define the problem space, root causes, and "How Might We" question
- **Output:** Problem statement + "How Might We" question

**2. Create Formal Problem Statement**
- **Participants:** PM
- **Duration:** 30 minutes
- **Format:** "Who has this problem / What is the problem / Why is it painful / Evidence"
...
- **Duration:** 60 minutes
- **Format:** Hypothesis-driven — name, role, goals, pain points, current behaviour
...
- **Duration:** 90 minutes
- **Technique:** Mom Test (Rob Fitzpatrick) — ask about past behaviour, not future intent; avoid leading questions; listen for workarounds
...
- **Methodology:** Problem validation, JTBD, switch interviews — focus on past behaviour not hypotheticals
...
- **Duration:** 90 minutes
- **Technique:** Map each stage — actor, touchpoints, thoughts, feelings, pain points, opportunities
...
- **Participants:** PM, design, engineering lead
- **Duration:** 90 minutes
- **Technique:** Teresa Torres OST — opportunity → solution → experiment hierarchy. Don't anchor on a single solution.
...
- **Technique:** Define assumptions, hypotheses, and minimal experiments before building
...
- **Format:** "We believe [solution] will [outcome] because [reason]. We'll measure success by [metric]."
...
│  ├─ Problem framing canvas (120 min)
│  ├─ Problem statement (30 min)
│  └─ [Optional] Proto-personas, JTBD statements
│
├─ Day 3: Research Planning
│  ├─ Interview prep — Mom Test questions (90 min)
...
│  ├─ Opportunity Solution Tree — Teresa Torres (90 min)
│  └─ Design experiments
│
...
**Fix:** Use Mom Test questions (Rob Fitzpatrick) — ask about past behaviour, not future intent: "Tell me about the last time you faced this problem"
...
- `skills/prd-development/SKILL.md` — downstream workflow (Phase 6 GO output)
...
**Skill type:** Workflow
**Location:** `skills/discovery-process/SKILL.md`
**Dependencies:** Feeds into `prd-development`; 6-phase discovery loop over 3-4 weeks
