...
```bash
python ${CLAUDE_PLUGIN_ROOT}/skills/ceo-advisor/scripts/strategy_analyzer.py
```
Analyzes strategic position and generates actionable recommendations.

### For Financial Scenarios
```bash
python ${CLAUDE_PLUGIN_ROOT}/skills/ceo-advisor/scripts/financial_scenario_analyzer.py
```
